...
urlpatterns  =  [
	...
	url(r'^(?P<username>[-\w]+)/dashboard/$',          	views.dashboardView,      name='user-dashboard'),
	...
	url(r'^news/(?P<news_title>[-\w]+)/url=(?P<url_link>[-\w]+)/$',     views.loadExternalNews,       name = 'news-details')
